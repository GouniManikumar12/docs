...
|-------|-------------|-------------------|
| **CPM** | Per 1,000 exposures | Charge on impression, clicks free |
...
1. **CPX Model ≠ Traditional CPM**
   - CPM: Charges per 1,000 exposures (volume-based)
...
This approach is **purpose-built** for conversational AI environments where intent, context, and verified exposure matter more than raw exposures.
