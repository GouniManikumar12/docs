...
- CPA: Disabled
- Your offer continues to get exposures and clicks with the higher rates
...
<AccordionGroup>
  ...
  <Accordion title="What happens when budget reaches zero?">
    Your offer stops being shown to new users. Existing clicks in progress are still processed, but no new exposures are delivered.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Budget & Performance" icon="chart-line" href="/advertisers/budget-performance">
    Learn how to set and manage your campaign budget and track ROI.
  </Card>
