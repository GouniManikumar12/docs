...
|----------------------------------|--------------------------------|
| Charges per 1,000 *page exposures* | Charges per *verified exposure* inside an AI response |
...
| Often inflated by passive exposures | Fired only when **recommendations are actually shown** |
