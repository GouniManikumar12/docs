...
<CardGroup cols={2}>
  ...
  <Card title="Pricing Model" icon="dollar-sign" href="/advertisers/pricing">
    Explore how CPX, CPC, and CPA work together.
  </Card>
  <Card title="Advertiser Overview" icon="store" href="/advertisers/overview">
    Learn how to manage campaigns and visibility.
  </Card>
  <Card title="Reports Dashboard" icon="chart-bar" href="/advertisers/reports">
    Track your CPX efficiency in real time.
  </Card>
</CardGroup>
