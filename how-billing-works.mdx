...
<AccordionGroup>
  ...
  <Accordion title="2. Click (When User Clicks)">
    ...
    - `billing_reason = "First click or new session"` (unless duplicate click)
...
This approach is **not traditional** but is **purpose-built** for conversational AI environments where intent, context, and verified exposure matter more than raw exposures.
