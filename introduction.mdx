...
- Handle rendering, tracking, theming, and transparency labels  
- Support native recommendation layouts such as tail, product cards, and bridge flows  
...
<CardGroup cols={2}>
  ...
  >
    Explore React and Flutter frontend SDK integrations.
  </Card>
...
1. **Choose your SDK** — Frontend (React or Flutter) or Backend (Node.js)  
