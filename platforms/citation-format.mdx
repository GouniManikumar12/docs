...
description: "Display recommendations as inline citations or product cards with automatic tracking using admesh-ui-sdk v1.0.0"
---

## Overview

The **Citation & Product Format** uses the `AdMeshRecommendations` component to display recommendations as a separate UI element. This is the easiest way to integrate AdMesh.
...
- ❌ You want to embed links directly in LLM responses (use `WeaveAdFormatContainer` instead)
