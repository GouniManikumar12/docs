...
|------|------|----------|-------------|
| `recommendations` | `Recommendation[]` | Yes | Array of recommendation objects |
| `layout` | `string` | No | Layout type: `auto`, `grid`, `list`, `citation` |
| `onRecommendationClick` | `function` | No | Click handler: `(adId, admeshLink) => void` |
| `className` | `string` | No | Custom CSS class |
| `style` | `object` | No | Inline styles |
| `showPricing` | `boolean` | No | Show pricing information (default: true) |
| `showFeatures` | `boolean` | No | Show features list (default: true) |
| `maxItems` | `number` | No | Maximum recommendations to display |
