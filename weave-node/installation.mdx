...
The AdMeshClient requires only your API key to initialize. All other settings are configured internally for optimal performance.
...
- **API Endpoint:** Automatically configured to `https://api.useadmesh.com` (production)
- **Debug Mode:** Automatically enabled in development environments (`NODE_ENV === 'development'`)
- **Timeouts & Retries:** Configured internally with sensible defaults for reliability
