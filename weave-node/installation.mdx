...
<Note>
See the [canonical Weave prompt template](/platforms/weave-ad-format#canonical-weave-prompt-template) for link requirements, Ad labeling, and retry behavior.
</Note>
